...
5.1 Generic Web Service Security Verification
5.2 RESTful Web Service Verification
5.3 SOAP Web Service Verification
5.4 GraphQL and other Web Service Data Layer Security

5.5 GET/POST requests
5.6 HTTP URL construction and content
5.7 HTTP Methods allowed
5.8 HTTP Headers

5.9 HTTP Request handling i.e.: specific response types such as 406 Unacceptable, 404 File not Found

Note: please take into account that Web (and API) functionality generally must consider other security domains listed within this form i.e. authentication, authorization and access control, Error message handling.
